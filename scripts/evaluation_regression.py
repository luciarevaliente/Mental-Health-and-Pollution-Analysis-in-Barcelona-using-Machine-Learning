...
if __name__ == "__main__":
    ...
    # y_train_grouped = y_train.replace({9: 8})  # Cambiar clase 10 por 9 en el conjunto de entrenamiento
    # y_test_grouped = y_test.replace({9: 8})    # Cambiar clase 10 por 9 en el conjunto de prueba
    ...
    for model_name in model_types:
        ...
        target_classes = [1, 2, 3, 4, 5, 6, 7,8,9]  # Clase 10 ya está incluida en la clase 9
